...
#ifndef ITKMYRESAMPLEIMAGEFILTER_HXX
#define ITKMYRESAMPLEIMAGEFILTER_HXX
...
MyResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
...

{
    ...
    //Self::SetTransform(IdentityTransform< TTransformPrecisionType, OutputImageDimension >::New());
...
template< typename TInputImage,
        ...
        typename TInterpolatorPrecisionType,
        typename TTransformPrecisionType >
typename MyResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
::PixelType
MyResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
...
template< typename TInputImage,
        ...
        typename TInterpolatorPrecisionType,
        typename TTransformPrecisionType >
auto MyResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
...
::GenerateInputRequestedRegion()
{
    ...
    // SpecialCoordinatesImage. If either are, then we cannot use the
    // fast path since index mapping will definitely not be linear.
    typedef SpecialCoordinatesImage< PixelType, OutputImageDimension >           OutputSpecialCoordinatesImageType;
    ...
    if ( !isSpecialCoordinatesImage && transform->GetTransformCategory() == TransformType::Linear )
    {
        ...
        inputRequestedRegion = MyImageAlgorithm::EnlargeRegionOverBox(output->GetRequestedRegion(),
                                                                    output,
                                                                    input,
                                                                    transform);
...
::GenerateOutputInformation()
{
    ...
    // throws exception .. can't cast DataObject from imageBase..
    //if (InputImageDimension == OutputImageDimension) could work.. need to test
...
#endif //ITKMYRESAMPLEIMAGEFILTER_HXX
